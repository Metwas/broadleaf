import Vector2 from "../graphics/vectors/vector2";
...
var math = {
      ...
      */
     lerp: function (x0: number, x1: number, t: number): number {
      ...
      */
     lerpColor: function (obj: object, beginColor: Color, endColor: Color, iterations: number, duration: number): void {
      ...
      */
     square: function (value: number): number {
      ...
      */
     dist: function (x0: number, x1: number): number {
      ...
      */
     distVector: function (vector0: Vector2, vector1: Vector2): object {
